...
Миграции — встроенный инструмент для создания и изменения схемы базы данных. Во время анализа файлов с моделями Django получает информацию о том, какая схема требуется для полноценной работы. Если описанные в файлах моделей таблицы и колонки не совпадают с известными Django-таблицами, то фреймворк предложит вам исправить несоответствие.

### просмотреть все миграции showmigrations
...
Список имеющихся на хосте образов можно получить с помощью команды docker images
